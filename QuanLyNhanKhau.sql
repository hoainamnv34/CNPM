...
INSERT INTO dbo.NhanKhau (MaNhanKhau, HoTen, CCCD, NgaySinh, GioiTinh, QueQuan, ThuongTru, Dantoc, NgheNghiep)
VALUES
('NK.0000100', N'Võ Hoài Nam', '0000000000', '2002-04-20', N'Nam', N'Kỳ Thư - Kỳ Anh - Hà Tĩnh', N'Số 2 Tạ Quang Bửu- Hai Bà Trưng- Hà Nội',N'Kinh', N'Sinh viên')
...
UPDATE dbo.ThanhVienCuaHo SET MaHoKhau   = ' ', QuanHeVoiCH = ' ', MaTrongHoKhau = (SELECT COUNT(*) FROM dbo.ThanhVienCuaHo WHERE MaHoKhau = '') + 1 WHERE MaNhanKhau = ' '
